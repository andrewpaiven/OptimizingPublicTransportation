...
class Line:
    ...
    def process_message(self, message):
        ...
        logger.info(f"Processing line message from topic {message.topic()}")
        ...
        if message.topic() == "org.chicago.cta.station.arrivals.v1":  # Set the conditional to the arrival topic
